...
__nv _q15 dst_nv[S1_RS][S1_CS] = {{_Q15(0.1), _Q15(0.2)}, {_Q15(0.3), _Q15(0.4)}};
...
__atomic__ safe_matmult(__output__[D_RS*D_CS*2] int* dst, 
	__input__[S1_RS*S1_CS*2] int* src1,
	__input__[S2_RS*S2_CS*2] int* src2) {
...
#else
			safe_matmult(*dst_nv, *src_nv, *src_nv);
#endif
		}
