...
//	DMACTL4 |= ENNMI;
	...
	__disable_interrupt();
	DMA1CTL |= (DMADT_5 | DMASRCINCR_3 | DMADSTINCR_3 | DMAEN | DMAREQ | DMAIE);
	//DMA1CTL |= (DMADT_5 | DMASRCINCR_3 | DMADSTINCR_3 | DMAEN | DMAREQ);
